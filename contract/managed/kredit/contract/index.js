...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      unregisterIssuer: (...args_1) => {
        ...
        const issuerId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('unregisterIssuer',
                                     'argument 1 (as invoked from Typescript)',
      ...
      proveNotRevoked: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveNotRevoked',
                                     'argument 1 (as invoked from Typescript)',
  ...
  _credentialScore_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 65535n)) {
      __compactRuntime.typeError('credentialScore',
                                 'return value',
...
export const pureCircuits = {
  deriveAdminPk: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('deriveAdminPk',
                                 'argument 1',
